...
export const MobileHeader: React.FC = () => {
  ...
  const renderNavItem = (item: NavItem) => {
    return (
      <Link
        ...
        className={`
          relative flex items-center gap-2.5 px-3 py-4 rounded-lg transition-all duration-300 ease-in-out group isolate
          ${isActive(item.path)
  ...
  return (
    <>
      <header className="md:hidden bg-[#17181A] rounded-b-[20px] p-5 flex items-center justify-between">
        <div className="w-10 h-10 flex items-center">
          <img src="/src/assets/images/logo.png" alt="MCI Logo" className="w-full h-full object-contain" />
        </div>
        
        <div className="flex items-center gap-3">
          <button className="bg-[#414141] hover:bg-[#414141]/80 p-3 rounded-full transition-colors">
            <Search size={20} className="text-white" />
          </button>
          <button 
            onClick={() => setIsMenuOpen(!isMenuOpen)}
            className="bg-[#414141] hover:bg-[#414141]/80 p-3 rounded-full transition-colors"
          >
      ...
      {isMenuOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 md:hidden flex items-center justify-center p-5">
            <div className="bg-[#17181A] rounded-[20px] w-full max-w-[393px] max-h-[90vh] overflow-hidden flex flex-col animate-in slide-in-from-top-2">
              {/* Modal Header */}
              <div className="p-5 flex items-center justify-between border-b border-[#2F3133]">
                <div className="w-10 h-10 flex items-center">
                  <img src="/src/assets/images/logo.png" alt="MCI Logo" className="w-full h-full object-contain" />
                </div>
                <button 
                  onClick={() => setIsMenuOpen(false)}
                  className="bg-[#414141] hover:bg-[#414141]/80 p-2 rounded-full transition-colors"
                >
              ...
              <div className="flex-1 overflow-y-auto p-5 flex flex-col gap-5">
                ...
                <div className="flex items-center gap-4 pt-5 border-t border-[#2F3133]">
